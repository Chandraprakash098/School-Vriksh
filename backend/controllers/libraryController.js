...
const libraryController = {
  ...
  //     const issue = new BookIssueModel({
  //       school: schoolId,
  //       book: bookId,
  //       user: studentId,
  //       issueDate: new Date(),
  ...
  //     logger.info(`Book issued: ${book.bookTitle} to student ${studentId}`, { schoolId });
...
issueBook: async (req, res) => {
  ...
  //     if (book.coverImage) {
  //       try {
  //         const oldKey = book.coverImage.split('/').slice(-3).join('/'); // Extract key from URL

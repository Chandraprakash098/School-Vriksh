...
router.get('/documents/:applicationId/:documentKey', clerkController.streamDocument);
router.get('/certificates/:certificateId/:documentKey', clerkController.streamCertificate);
